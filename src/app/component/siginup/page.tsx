export default function sigup(){
    return(
        <div >
            ...
            <div className="bg-gray-50 flex flex-col justify-center items-center h-full w-full ">
          ...
          <div className="flex flex-col justify-center items-center mt-16 w-[90%] bg-white h-[70%] p-16">
            ...
            <input className="w-[354px] h-[56px] bg-gray-100 pl-4 placeholder:text-gray-400" type="text" placeholder="@your email" />
