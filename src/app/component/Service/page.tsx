            ...
            <div className="w-full h-full flex flex-col justify-center items-center mt-16 p-10">
                ...
                <div className="flex flex-col lg:flex-row justify-center items-center mt-16 gap-[14px] w-full">
                    ...
                    <div className="w-[305px] h-[244px] bg-[#F9F9F9] p-10">
                        ...
                        <p className="text-medium text-[#2a254b] font-light">Order before 3pm and get your order
                    ...
                    <div className="w-[305px] h-[244px] bg-[#F9F9F9] p-10">
                        ...
                        <p className="text-medium text-[#2a254b] font-light">Handmade crafted goods made with
                    ...
                    <div className="w-[305px] h-[244px] bg-[#F9F9F9] p-10">
                        ...
                        <p className="text-medium text-[#2a254b] font-light">We use 100% recycled packaging to ensure our footprint is manageable</p>
                    </div> 
