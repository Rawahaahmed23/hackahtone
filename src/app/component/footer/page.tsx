export default function Footer() {
    return (
      <footer className="bg-[#2a254b] text-white py-8 mt-16 border-b-2px">
        <div className="container flex flex-wrap justify-between w-[70%] mx-16">
        ...
        <div className="flex justify-center w-[90%] items-center border-t-2 border-t-purple-100  mt-8 gap-4 mx-16">
</div>
            <div>
            </div >
                <div className="flex flex-row justify-between w-[80%] mx-16">
